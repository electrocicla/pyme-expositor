 ...
 * A glowing, animated electric border wrapper
 * 
...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
      ...
      [...dyAnims, ...dxAnims].forEach((a: SVGAnimateElement) => {
        if (typeof a.beginElement === 'function') {
          try {
            ...
            console.warn('Failed to begin animation element:', error);
          }
        }
      });
    });
  ...
  // Expand the border effect outward by using negative inset
  const expandAmount = thickness + 4; // Extra padding for the electric effect
  const expandedInset: CSSProperties = {
    top: -expandAmount,
    left: -expandAmount,
    right: -expandAmount,
    bottom: -expandAmount,
  ...
  return (
    <div ref={rootRef} className={'relative isolate ' + (className ?? '')} style={{ ...style, overflow: 'visible' }}>
      <svg
        ref={svgRef}
      ...
      <div className="absolute inset-0 pointer-events-none overflow-visible" style={inheritRadius}>
        <div ref={strokeRef} className="box-border" style={strokeStyle} />
        <div className="box-border" style={glow1Style} />
        <div className="box-border" style={glow2Style} />
